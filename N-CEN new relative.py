...
for cik in CIK_List:
    ...
    df = df[df['filingDate'] >= yesterday_date]
    df = df[df['filingDate'] < today_date]
...
df = df.drop_duplicates(subset=["CIK", "shortNam", "EndDate","PeriodFY", "Period", "PeriodFP", "Field", "Value"])
